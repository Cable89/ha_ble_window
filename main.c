...
#define DEVICE_NAME                     "wndw_oysm_window"                       /**< Name of device. Will be included in the advertising data. */
...
static void notification_timeout_handler(void * p_context)
{
    ...
    err_code = ble_cus_custom_value_update(&m_cus, get_window_position());
    APP_ERROR_CHECK(err_code);
}
